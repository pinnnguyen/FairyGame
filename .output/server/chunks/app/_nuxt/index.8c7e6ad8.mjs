import { o as onClickOutside, _ as __nuxt_component_0 } from './index.1b8116ed.mjs';
import { f as defineStore, s as storeToRefs, g as useRequestHeaders, i as useAppStore, c as __nuxt_component_1$1, b as _export_sfc, j as __nuxt_component_0$1, u as useNuxtApp, h as createError, n as navigateTo$1 } from '../server.mjs';
import { useSSRContext, defineComponent, withCtx, createVNode, ref, mergeProps, unref, toDisplayString, computed, onUnmounted, watch, openBlock, createBlock, createCommentVNode, withModifiers, withAsyncContext, reactive, h, onServerPrefetch, defineAsyncComponent, Fragment, renderList } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttrs, ssrRenderSlot, ssrRenderTeleport, ssrRenderList, ssrRenderStyle } from 'vue/server-renderer';
import { _ as _sfc_main$a } from './ButtonConfirm.bfbf963d.mjs';
import { u as useSocket } from './useSocket.fbc3bedd.mjs';
import { u as usePlayerStore, s as set } from './usePlayer.7d831e1f.mjs';
import { Message, Icon } from 'vexip-ui';
import { r as randomNumber, _ as __nuxt_component_0$2 } from './index.6af014ab.mjs';
...
const __nuxt_component_3_lazy = /* @__PURE__ */ defineAsyncComponent(() => Promise.resolve().then(() => ItemRank).then((m) => m.default || m));
const _sfc_main$8 = {
  __name: "daily",
  __ssrInlineRender: true,
  emits: ["close"],
      ...
      _push(ssrRenderComponent(_component_Blocker, { class: "z-99" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="absolute top-[30px] grid grid-cols-1 gap-1 items-center justify-center w-[90%] left-[calc(10%_-_10px)] max-h-[410px] overflow-scroll"${_scopeId}><!--[-->`);
            ssrRenderList(unref(bossDaily), (boss) => {
              _push2(`<section class="w-[90%] h-[80px] bg-[#a0aac0cf] rounded flex justify-between"${_scopeId}><div class="flex flex-col items-center justify-center"${_scopeId}><div class="relative mr-2"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_NuxtImg, {
              ...
              _push2(`<p class="text-10 text-white h-3 object-cover absolute bottom-[2px] left-[calc(50%_-_20px)]"${_scopeId}>${ssrInterpolate(boss.name)}</p></div></div><div class="flex items-center justify-center"${_scopeId}><!--[-->`);
              ssrRenderList(parseEquipments(boss.reward.equipments), (equipment) => {
                _push2(ssrRenderComponent(_component_LazyItemRank, {
                  key: equipment.name,
                  class: "w-[40px] h-[40px]",
                  rank: equipment.rank,
              ...
              _push2(`<!--]--></div><div class="flex items-center z-1 flex flex-col justify-center items-center"${_scopeId}><p class="text-[#439546] text-12 font-semibold mr-2"${_scopeId}> L\u01B0\u1EE3t khi\xEAu chi\u1EBFn ${ssrInterpolate(boss.numberOfTurn)}</p>`);
              _push2(ssrRenderComponent(_component_ButtonConfirm, {
                "class-name": "h-[25px]",
                onClick: ($event) => startWar(boss)
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<span class="font-semibold text-[#9d521a] z-9"${_scopeId2}>Khi\xEAu chi\u1EBFn</span>`);
                  } else {
                    return [
              ...
              createVNode("div", {
                ...
                createVNode("div", { class: "w-[90%] h-[70%] absolute top-[calc(50%_-_35vh)]" }, [
                  createVNode("div", { class: "w-full h-full relative" }, [
                    ...
                    createVNode("div", { class: "absolute top-[30px] grid grid-cols-1 gap-1 items-center justify-center w-[90%] left-[calc(10%_-_10px)] max-h-[410px] overflow-scroll" }, [
                      (openBlock(true), createBlock(Fragment, null, renderList(unref(bossDaily), (boss) => {
                        return openBlock(), createBlock("section", {
                          key: boss.id,
                          class: "w-[90%] h-[80px] bg-[#a0aac0cf] rounded flex justify-between"
                        }, [
                          createVNode("div", { class: "flex flex-col items-center justify-center" }, [
                            createVNode("div", { class: "relative mr-2" }, [
                              createVNode(_component_NuxtImg, {
                                class: "w-[55px] h-[55px] rounded-full border border-[#bbc4d2]",
                                format: "webp",
                                src: boss.avatar
                              ...
                              createVNode("p", { class: "text-10 text-white h-3 object-cover absolute bottom-[2px] left-[calc(50%_-_20px)]" }, toDisplayString(boss.name), 1)
                            ])
                          ]),
                          createVNode("div", { class: "flex items-center justify-center" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(parseEquipments(boss.reward.equipments), (equipment) => {
                              return openBlock(), createBlock(_component_LazyItemRank, {
                                key: equipment.name,
                                class: "w-[40px] h-[40px]",
                                rank: equipment.rank,
                                preview: equipment.preview,
                                onClick: withModifiers(($event) => pickItem(equipment), ["stop"])
                              }, null, 8, ["rank", "preview", "onClick"]);
                            }), 128))
                          ]),
                          createVNode("div", { class: "flex items-center z-1 flex flex-col justify-center items-center" }, [
                            createVNode("p", { class: "text-[#439546] text-12 font-semibold mr-2" }, " L\u01B0\u1EE3t khi\xEAu chi\u1EBFn " + toDisplayString(boss.numberOfTurn), 1),
                            createVNode(_component_ButtonConfirm, {
                              "class-name": "h-[25px]",
                              onClick: withModifiers(($event) => startWar(boss), ["stop"])
                            }, {
                              default: withCtx(() => [
                                createVNode("span", { class: "font-semibold text-[#9d521a] z-9" }, "Khi\xEAu chi\u1EBFn")
                              ]),
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    computed(() => Math.round(BASE_EXP() * mids.value.current.reward.base.exp));
    computed(() => Math.round(BASE_EXP() * mids.value.current.reward.base.gold));
    return (_ctx, _push, _parent, _attrs) => {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="absolute bottom-0 text-center w-full flex justify-center flex-col items-center text-white"><div class="flex items-center justify-around w-full mb-4"><div class="flex items-center jsutify-center flex-col"><div class="diamond bg-[#4881bf] w-[30px] h-[30px]"></div><span class="whitespace-nowrap text-12 text-black/70 mt-1">C\xF4ng ph\xE1p</span></div><div class="flex items-center jsutify-center flex-col"><div class="diamond bg-[#4881bf] w-[30px] h-[30px]"></div><span class="whitespace-nowrap text-12 text-black/70 mt-1">Phi th\u0103ng</span></div><div class="flex items-center jsutify-center flex-col"><div class="diamond bg-[#4881bf] w-[30px] h-[30px]"></div><span class="whitespace-nowrap text-12 text-black/70 mt-1">T\xF4ng m\xF4n</span></div><div class="flex items-center jsutify-center flex-col"><div class="diamond bg-[#4881bf] w-[30px] h-[30px]"></div><span class="whitespace-nowrap text-12 text-black/70 mt-1">Th\xE0nh t\xEDch</span></div><div class="flex items-center jsutify-center flex-col"><div class="diamond bg-[#4881bf] w-[30px] h-[30px]"></div><span class="whitespace-nowrap text-12 text-black/70 mt-1">C\xE0i \u0111\u1EB7t</span></div></div><div class="h-12 w-full flex justify-around items-center bg-[#1d3a62]">`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        class: "w-[45px]",
...
mongoose.models && mongoose.models.PlayerSchemas ? mongoose.models.PlayerSchemas : mongoose.model("PlayerSchemas", schema$b, "players");
...
schema$a.index({ slot: -1 });
schema$a.index({ rank: -1 });
mongoose.models && mongoose.models.PlayerEquipmentSchemas ? mongoose.models.PlayerEquipmentSchemas : mongoose.model("PlayerEquipmentSchemas", schema$a, "player_equipments");
...
mongoose.models && mongoose.models.MonsterSchema ? mongoose.models.MonsterSchema : mongoose.model("MonsterSchema", schema$9, "monsters");
...
mongoose.models && mongoose.models.MidSchema ? mongoose.models.MidSchema : mongoose.model("MidSchema", schema$8, "mids");
...
mongoose.models && mongoose.models.BossSchema ? mongoose.models.BossSchema : mongoose.model("BossSchema", schema$7, "boss");
...
schema$6.index({ sid: -1 }, { unique: true });
mongoose.models && mongoose.models.PlayerAttributeSchema ? mongoose.models.PlayerAttributeSchema : mongoose.model("PlayerAttributeSchema", schema$6, "player_attributes");
...
schema$5.index({ createdAt: -1 });
mongoose.models && mongoose.models.BattleSchemas ? mongoose.models.BattleSchemas : mongoose.model("BattleSchemas", schema$5, "battles");
...
mongoose.models && mongoose.models.UserSchema ? mongoose.models.UserSchema : mongoose.model("UserSchema", schema$4, "users");
...
mongoose.models && mongoose.models.PlayerEquipUpgradeSchema ? mongoose.models.PlayerEquipUpgradeSchema : mongoose.model("PlayerEquipUpgradeSchema", schema$3, "player_equip_upgrade");
...
mongoose.models && mongoose.models.ItemSchema ? mongoose.models.ItemSchema : mongoose.model("ItemSchema", schema$2, "items");
...
mongoose.models && mongoose.models.PlayerItemSchemas ? mongoose.models.PlayerItemSchemas : mongoose.model("PlayerItemSchemas", schema$1, "player_items");
...
schema.index({ rank: -1 });
mongoose.models && mongoose.models.EquipmentSchemas ? mongoose.models.EquipmentSchemas : mongoose.model("EquipmentSchemas", schema, "equipments");
...
//# sourceMappingURL=index.8c7e6ad8.mjs.map
