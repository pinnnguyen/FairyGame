...
import { u as usePlayerStore, s as set } from './usePlayer.ee6d41eb.mjs';
import { u as useSocket } from './useSocket.fbc3bedd.mjs';
import { _ as _sfc_main$a } from './ButtonConfirm.7c007c24.mjs';
...
const __nuxt_component_3_lazy = /* @__PURE__ */ defineAsyncComponent(() => import('./list-daily.ae0bb3a3.mjs').then((m) => m.default || m));
const __nuxt_component_4_lazy = /* @__PURE__ */ defineAsyncComponent(() => import('./list-frame-time.864a1bde.mjs').then((m) => m.default || m));
const _sfc_main$8 = {
  __name: "daily",
  __ssrInlineRender: true,
  emits: ["close"],
...
//# sourceMappingURL=index.5e160408.mjs.map
