import { f as formatCash, _ as __nuxt_component_0$2 } from './index.2feaf918.mjs';
import { useSSRContext, mergeProps, defineComponent, ref, withCtx, createVNode, toDisplayString, unref, computed, onUnmounted, openBlock, createBlock, createCommentVNode, Fragment, renderList, createTextVNode, withModifiers, defineAsyncComponent } from 'vue';
import { c as __nuxt_component_0$1, s as storeToRefs, d as useRoute, n as navigateTo$1, e as __nuxt_component_2 } from '../server.mjs';
...
import { B as BATTLE_TURN, u as useBattleRoundStore } from './useBattleRound.23b9a804.mjs';
...
const __nuxt_component_1_lazy = /* @__PURE__ */ defineAsyncComponent(() => import('./battle-result.b75fa0a8.mjs').then((m) => m.default || m));
          ...
          if (_push2) {
            ...
            if (unref(loading)) {
              ...
              if (!unref(hasBossDaily)) {
                _push2(`<div class="text-center pt-2 text-base font-semibold flex items-center justify-center"${_scopeId}> [${ssrInterpolate((_a = unref(state).enemy) == null ? void 0 : _a.name)}] </div>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              if (unref(showPlayerInfo)) {
                _push2(ssrRenderComponent(_component_BattleInfo, {
                  name: (_b = unref(state).player) == null ? void 0 : _b.name,
                  hp: (_c = unref(state).player) == null ? void 0 : _c.hp,
                  damage: (_d = unref(state).player) == null ? void 0 : _d.damage,
                  def: (_e = unref(state).player) == null ? void 0 : _e.def,
              ...
              if (unref(showEnemyInfo)) {
                _push2(ssrRenderComponent(_component_BattleInfo, {
                  name: (_f = unref(state).enemy) == null ? void 0 : _f.name,
                  hp: (_g = unref(state).enemy) == null ? void 0 : _g.hp,
                  damage: (_h = unref(state).enemy) == null ? void 0 : _h.damage,
                  def: (_i = unref(state).enemy) == null ? void 0 : _i.def,
              ...
              _push2(`</div></div><div class="flex items-end justify-end"${_scopeId}><div class="h-[170px] overflow-auto w-[48%] bg-[#6879a3] mt-2 mx-2 rounded float-left"${_scopeId}><p class="text-center text-base font-semibold"${_scopeId}> L\u1ECBch s\u1EED </p>`);
              _push2(ssrRenderComponent(_component_BattleHistory, { "battle-rounds": unref(battleRounds) }, null, _parent2, _scopeId));
              _push2(`</div><div class="w-[80%] h-[170px] overflow-auto float-right bg-[#6879a3] mt-2 mx-2 rounded"${_scopeId}><p class="text-center text-base font-semibold"${_scopeId}> H\u1EA1ng s\xE1t th\u01B0\u01A1ng </p><div class="p-2 text-white"${_scopeId}><!--[-->`);
              ssrRenderList(unref(rankDMG), (rank) => {
                _push2(`<div class="flex justify-between mx-1 my-1"${_scopeId}><span${_scopeId}>(1) ${ssrInterpolate(rank._id)}</span> <span${_scopeId}>${ssrInterpolate(unref(formatCash)(rank.totalDamage))}</span></div>`);
              });
              _push2(`<!--]--></div></div></div><div class="flex items-center flex-col justify-center fixed w-full bottom-2"${_scopeId}>`);
              if (unref(inRefresh)) {
            ...
            return [
              ...
              unref(loading) ? (openBlock(), createBlock(_component_loadingScreen, { key: 1 })) : (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "h-[60%] bg-bg_pve bg-cover" }, [
                  ...
                  }, " [" + toDisplayString((_j = unref(state).enemy) == null ? void 0 : _j.name) + "] ", 1)) : createCommentVNode("", true),
                  createVNode("div", { class: "flex justify-between p-2 pt-2" }, [
                    createVNode("div", null, [
                      ...
                      unref(showPlayerInfo) ? (openBlock(), createBlock(_component_BattleInfo, {
                        key: 0,
                        name: (_k = unref(state).player) == null ? void 0 : _k.name,
                        hp: (_l = unref(state).player) == null ? void 0 : _l.hp,
                        damage: (_m = unref(state).player) == null ? void 0 : _m.damage,
                        def: (_n = unref(state).player) == null ? void 0 : _n.def,
                        onClose: ($event) => showPlayerInfo.value = false
                    ...
                    createVNode("div", null, [
                      ...
                      unref(showEnemyInfo) ? (openBlock(), createBlock(_component_BattleInfo, {
                        key: 0,
                        name: (_o = unref(state).enemy) == null ? void 0 : _o.name,
                        hp: (_p = unref(state).enemy) == null ? void 0 : _p.hp,
                        damage: (_q = unref(state).enemy) == null ? void 0 : _q.damage,
                        def: (_r = unref(state).enemy) == null ? void 0 : _r.def,
                        onClose: ($event) => showEnemyInfo.value = false
                      }, null, 8, ["name", "hp", "damage", "def", "onClose"])) : createCommentVNode("", true)
                    ])
                  ]),
                ...
                createVNode("div", { class: "flex items-end justify-end" }, [
                  createVNode("div", { class: "h-[170px] overflow-auto w-[48%] bg-[#6879a3] mt-2 mx-2 rounded float-left" }, [
                    createVNode("p", { class: "text-center text-base font-semibold" }, " L\u1ECBch s\u1EED "),
                    createVNode(_component_BattleHistory, { "battle-rounds": unref(battleRounds) }, null, 8, ["battle-rounds"])
                  ]),
                  createVNode("div", { class: "w-[80%] h-[170px] overflow-auto float-right bg-[#6879a3] mt-2 mx-2 rounded" }, [
                    createVNode("p", { class: "text-center text-base font-semibold" }, " H\u1EA1ng s\xE1t th\u01B0\u01A1ng "),
                    createVNode("div", { class: "p-2 text-white" }, [
                      (openBlock(true), createBlock(Fragment, null, renderList(unref(rankDMG), (rank) => {
                        return openBlock(), createBlock("div", {
                          key: rank._id,
                          class: "flex justify-between mx-1 my-1"
                        }, [
                          createVNode("span", null, "(1) " + toDisplayString(rank._id), 1),
                          createTextVNode(),
                          createVNode("span", null, toDisplayString(unref(formatCash)(rank.totalDamage)), 1)
                        ]);
                      }), 128))
                    ])
                  ])
...
const _boss_ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: _sfc_main
}, Symbol.toStringTag, { value: "Module" }));

export { _sfc_main$1 as _, _boss_ as a };
//# sourceMappingURL=_boss_.18fadbd8.mjs.map
