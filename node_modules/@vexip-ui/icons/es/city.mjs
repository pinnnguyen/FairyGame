import C from "./city.vue_vue_type_script_lang.mjs";
import { openBlock as V, createElementBlock as H, createElementVNode as t } from "vue";
...
function c(n, _, z, M, a, i) {
  return V(), H("svg", o, s);
}
const f = /* @__PURE__ */ e(C, [["render", c]]);
export {
  f as default
};
