  ...
  <div class="h-full flex items-center justify-center">
    <div class="grid grid-cols-2 gap-4 mb-2">
      ...
      <div class="relative" :class="{ 'bg-iconbg_3 bg-contain bg-no-repeat': slot4?.preview }">
        ...
        <ItemRank v-else format="webp" class="w-[55px] h-[55px]" :quantity="0" :rank="slot4.rank" :preview="slot4?.preview" @click="openDetail(slot4)" />
      </div>
      <div class="relative" :class="{ 'bg-iconbg_3 bg-contain bg-no-repeat': slot5?.preview }">
        ...
        <ItemRank v-else format="webp" class="w-[55px] h-[55px]" :quantity="0" :rank="slot5.rank" :preview="slot5?.preview" @click="openDetail(slot5)" />
      </div>
      <div class="relative" :class="{ 'bg-iconbg_3 bg-contain bg-no-repeat': slot6?.preview }">
        ...
        <ItemRank v-else format="webp" class="w-[55px] h-[55px]" :quantity="0" :rank="slot6.rank" :preview="slot6?.preview" @click="openDetail(slot6)" />
      </div>
      <div class="relative" :class="{ 'bg-iconbg_3 bg-contain bg-no-repeat': slot7?.preview }">
        ...
        <ItemRank v-else format="webp" class="w-[55px] h-[55px]" :quantity="0" :rank="slot7.rank" :preview="slot7?.preview" @click="openDetail(slot7)" />
      </div>
      <div class="relative" :class="{ 'bg-iconbg_3 bg-contain bg-no-repeat': slot8?.preview }">
        ...
        <ItemRank v-else format="webp" class="w-[55px] h-[55px]" :quantity="0" :rank="slot8.rank" :preview="slot8?.preview" @click="openDetail(slot8)" />
      </div>
    </div>
  </div>
</template>
