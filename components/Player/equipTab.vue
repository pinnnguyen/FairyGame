  ...
  <div class="h-full flex items-end justify-center">
    <div class="grid grid-cols-4 gap-2 mb-2">
      <div class="relative" :class="{ 'bg-iconbg_3 bg-contain bg-no-repeat': slot1?.preview }">
        ...
        <ItemRank v-else format="webp" class="w-[55px] h-[55px]" :rank="slot1.rank" :preview="slot1?.preview" @click="openDetail(slot1)" />
      </div>
      <div class="relative" :class="{ 'bg-iconbg_3 bg-contain bg-no-repeat': slot2?.preview }">
        ...
        <ItemRank v-else format="webp" class="w-[55px] h-[55px]" :rank="slot2.rank" :preview="slot2?.preview" @click="openDetail(slot2)" />
      </div>
      ...
      <div class="relative" :class="{ 'bg-iconbg_3 bg-contain bg-no-repeat': slot4?.preview }">
        ...
        <ItemRank v-else format="webp" class="w-[55px] h-[55px]" :rank="slot4.rank" :preview="slot4?.preview" @click="openDetail(slot4)" />
      </div>
      <div class="relative" :class="{ 'bg-iconbg_3 bg-contain bg-no-repeat': slot5?.preview }">
        ...
        <ItemRank v-else format="webp" class="w-[55px] h-[55px]" :rank="slot5.rank" :preview="slot5?.preview" @click="openDetail(slot5)" />
      </div>
      <div class="relative" :class="{ 'bg-iconbg_3 bg-contain bg-no-repeat': slot6?.preview }">
        ...
        <ItemRank v-else format="webp" class="w-[55px] h-[55px]" :rank="slot6.rank" :preview="slot6?.preview" @click="openDetail(slot6)" />
      </div>
      <div class="relative" :class="{ 'bg-iconbg_3 bg-contain bg-no-repeat': slot7?.preview }">
        ...
        <ItemRank v-else format="webp" class="w-[55px] h-[55px]" :rank="slot7.rank" :preview="slot7?.preview" @click="openDetail(slot7)" />
      </div>
      <div class="relative" :class="{ 'bg-iconbg_3 bg-contain bg-no-repeat': slot8?.preview }">
        ...
        <ItemRank v-else format="webp" class="w-[55px] h-[55px]" :rank="slot8.rank" :preview="slot8?.preview" @click="openDetail(slot8)" />
      </div>
    </div>
  </div>
</template>
